...
class GalleryFragment : Fragment() {
    ...
    private fun runHolisticOnVideo(uri: Uri) {
        ...
        val cachePath = cacheDir.absolutePath + "/sign_frames/"
        ...
        backgroundScope?.launch {
            ...
            FFmpegKit.execute("-i $inputVideoPath -vf fps=30 $cachePath%04d.jpg")
            ...
            if (folder.exists()) {
                ...
                var timePerFrame = SystemClock.uptimeMillis()
